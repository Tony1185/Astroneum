...
export function createFibonacciOptions (locale: string): SelectDataSourceItem[] {
  return [
    ...
    { key: 'fibonacciChannel', text: i18n('fibonacci_channel', locale) },
    { key: 'fibonacciWedge', text: i18n('fibonacci_wedge', locale) },
    { key: 'fibonacciTimeZones', text: i18n('fibonacci_time_zones', locale) },
    { key: 'fibonacciArcs', text: i18n('fibonacci_arcs', locale) },
    { key: 'fibonacciFan', text: i18n('fibonacci_fan', locale) },
